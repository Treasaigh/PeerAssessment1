...
The mean is <b>`r mean(ACT_Totals$steps)`</b> and the median is <b>`r median(ACT_Totals$steps)`</b>
...
The <b>`r MaximumInterval$interval`</b> interval has the maximum steps:  <b>`r MaximumInterval$steps`</b>.
...
The total number of missing values is: <b>`r MissingValues`</b> 
...
<ul>
  <li>Before filling the data</li>
      Mean: `r mean(ACT_Totals$steps)`  
      Median: `r median(ACT_Totals$steps)`
  <li>After filling the data</li>
      Mean: `r mean(totalStepsByDayImputed, na.rm=TRUE)`  
      Median: `r median(totalStepsByDayImputed, na.rm=TRUE)`
</ul>
